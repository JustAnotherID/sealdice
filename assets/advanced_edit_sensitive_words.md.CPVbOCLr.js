import{_ as a,c as n,o as i,a8 as p}from"./chunks/framework.C7mXLKkK.js";const c=JSON.parse('{"title":"编写敏感词库","description":"","frontmatter":{"lang":"zh-cn","title":"编写敏感词库"},"headers":[],"relativePath":"advanced/edit_sensitive_words.md","filePath":"advanced/edit_sensitive_words.md","lastUpdated":1758362343000}'),l={name:"advanced/edit_sensitive_words.md"};function t(e,s,h,k,r,d){return i(),n("div",null,[...s[0]||(s[0]=[p(`<h1 id="编写敏感词库" tabindex="-1">编写敏感词库 <a class="header-anchor" href="#编写敏感词库" aria-label="Permalink to &quot;编写敏感词库&quot;">​</a></h1><div class="info custom-block"><p class="custom-block-title">本节内容</p><p>本节将介绍敏感词库的编写，请善用侧边栏和搜索，按需阅读文档。</p></div><h2 id="创建文本格式的敏感词库" tabindex="-1">创建文本格式的敏感词库 <a class="header-anchor" href="#创建文本格式的敏感词库" aria-label="Permalink to &quot;创建文本格式的敏感词库&quot;">​</a></h2><p>你可以直接按照以下格式书写 <code>&lt;words&gt;.txt</code>：</p><div class="language-text vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang">text</span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>#notice</span></span>
